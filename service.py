...
SERVICE_NAME = "onboarding-relevance-fresh-04"
PEERS: tuple[Peer, ...] = (
    Peer("avior-test-ob-org/onboarding-relevance-fresh-05", "FRESH_05_URL"),
    Peer("avior-test-ob-org/onboarding-relevance-fresh-06", "FRESH_06_URL"),
)
